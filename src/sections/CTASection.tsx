    ...
    <section className="py-8 lg:py-12 bg-[#325BFF] relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
        ...
        ><a
          ...
          className="bg-[#EBB35C] text-[#325BFF] px-6 lg:px-8 py-3 lg:py-4 rounded-full hover:bg-[#325BFF] hover:text-white font-bold text-sm lg:text-base shadow-lg transition-all duration-300"
        >
            Start Free Trial →
          </a>
        </motion.div>
