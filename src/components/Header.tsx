...
// type MenuItem = "Home" | "About" | "Services" | "Contact";

// const menuItems: MenuItem[] = ["Home", "About", "Services", "Contact"];
...
//           >
//             <div className=" backdrop-blur-sm text-white px-4 py-2 rounded-lg hover:bg-white/20 transition-all duration-300">
//               <img
...
//             className="bg-[#EBB35C] text-white px-6 py-2.5 rounded-full hover:bg-[#d9a04a] hover:shadow-lg hover:scale-105 transition-all duration-300 font-semibold text-base"
//           >
//             Get Started
//           </motion.a>
//         )}
